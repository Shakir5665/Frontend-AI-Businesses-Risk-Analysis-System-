...
import { ArrowRight, Globe, MessageSquare, Briefcase, Camera, Sparkles, ArrowUpRight } from "lucide-react";
...
export default function CTAFooter({ className }) {
  ...
  const itemVariants = {
    ...
    visible: { y: 0, opacity: 1, transition: { duration: 0.6, ease: [0.21, 0.45, 0.32, 0.9] } },
  };
        ...
        <section className="w-full relative pt-[120px] pb-0 overflow-hidden flex flex-col items-center">
          ...
          <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-[96px] relative z-10 flex flex-col items-center">
            <div className="max-w-[1248px] w-full flex flex-col items-center">
              ...
              >
                Start analyzing your <span className="italic text-[rgba(0,0,0,0.40)]">business risks</span> today
              </motion.h2>
              ...
              >
                Paste a product URL, let AI analyze thousands of customer reviews, and make smarter business decisions — all in minutes.
              </motion.p>
              ...
              >
                <CTAButton text="Analyze Product" variant="primary" onClick={() => navigate("/login")} />
                <CTAButton text="Learn More" variant="secondary" onClick={() => {
          ...
          <div className="relative z-10 w-full max-w-[1440px] px-6 lg:px-[96px] pt-[64px] pb-[32px] flex flex-col items-start bg-transparent">
            ...
            >
              ...
              <div className="w-full lg:w-[440px] flex flex-col gap-6">
                ...
                <motion.p variants={itemVariants} className="text-[#042718] font-sans text-[18px] font-normal leading-[28px] opacity-80">
                  Get the latest AI insights, platform updates, and business risk analysis tips straight to your inbox.
                </motion.p>
              ...
              <div className="lg:ml-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:flex lg:flex-nowrap gap-y-12 gap-x-8 lg:gap-[64px] w-full lg:w-auto">
                ...
                <div className="lg:w-[152px] flex flex-col gap-[20px] relative">
                  ...
                  >Company</motion.h4>
                  <ul className="flex flex-col gap-[16px]">
                    {["About", "Research", "Blog", "Contact"].map((link) => (
                      <motion.li key={link} variants={itemVariants}>
                        <a href="#" className="text-[#042718] font-sans text-[18px] font-normal leading-[28px] opacity-80 hover:opacity-100 hover:font-medium transition-all">{link}</a>
                      </motion.li>
                    ))}
