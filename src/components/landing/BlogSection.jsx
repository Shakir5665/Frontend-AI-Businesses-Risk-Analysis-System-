...
function BlogCard({ image, date, title, description, tags, imageTop = true, delay = 0 }) {
  return (
    <motion.div
          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
              ...
              >
                ...
                <span className="text-[#138E5F] text-[13px] font-sans font-medium uppercase tracking-wider">Research Insights</span>
              </motion.div>
              ...
              <motion.h2
                ...
                style={{ fontFamily: "'Onest', sans-serif" }}
              >
                Insights to help you <span className="italic text-[rgba(4,39,24,0.40)]">understand</span> your customers better
              </motion.h2>
              ...
              >
                Learn how AI-powered review analysis can transform your business decision-making and help you grow.
              </motion.p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 justify-center">
              <BlogCard
                ...
                date="15 Jan 2026"
                title="How AI sentiment analysis reveals what customers really think"
                description="Discover how natural language processing transforms raw customer reviews into clear, actionable business signals that drive smarter decisions."
              ...
              <BlogCard
                ...
                date="03 Mar 2026"
                title="The Business Risk Index: A new way to measure e-commerce health"
                description="Explore how the BRI score combines sentiment, complaints, and aspect analysis into a single, actionable risk metric for business owners."
                tags={["AI", "Tech"]}
                imageTop={false}
                delay={0.4}
              />
