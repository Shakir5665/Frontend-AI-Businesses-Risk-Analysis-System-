...
function MetricCard({ number, suffix, title, description, delay }) {
  return (
    <motion.div
    ...
    >
      <div className="flex flex-col items-start w-full sm:w-[294px] p-[20px_24px] gap-2.5 rounded-[24px] bg-white/40 backdrop-blur-md border border-white/20 shadow-[0_8px_32px_rgba(4,39,24,0.06)]">
        ...
        <p className="text-[#042718] text-[18px] font-medium leading-[28px]">{title}</p>
      </div>
...
const testimonials = [
  {
    id: 1,
    text: "RiskAI completely changed how I evaluate my products. I used to guess why sales dropped — now I get clear evidence and risk scores from actual customer reviews.",
    name: "Ahmad Raza",
    role: "E-commerce Seller, Daraz",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop",
  },
  {
    id: 2,
    text: "The Business Risk Index gives me instant clarity on how risky my product listing is. I fixed my packaging complaints within days and my rating improved significantly.",
    name: "Layla Hassan",
  ...
  {
    id: 3,
    text: "I run multiple product listings and RiskAI helps me monitor all of them efficiently. The aspect-based analysis is incredibly detailed and saves me hours of manual review reading.",
    name: "Yusuf Ibrahim",
    role: "Product Manager, Online Store",
    avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop",
  },
  {
    id: 4,
    text: "The AI recommendations are spot on. It identified that my delivery complaints were hurting my ratings before I even noticed the trend — and gave me clear steps to fix it.",
    name: "Sarah Chen",
  ...
  {
    id: 5,
    text: "As a researcher evaluating AI business tools, I was impressed by the analytical depth. The evidence extraction and aspect identification are particularly strong and well-structured.",
    name: "Dr. James Patel",
...
export default function TestimonialsSection({ className }) {
  const metrics = [
    {
      ...
      description: "Processing thousands of real customer reviews with high AI accuracy every day.",
    },
    {
      number: 87,
      suffix: "%",
      title: "Risk Detection Rate",
      description: "Users identify business risks they previously missed using AI-powered review analysis.",
    },
    {
      number: 500,
      suffix: "+",
      title: "Businesses Served",
      description: "Trusted by entrepreneurs and business owners analyzing products across multiple platforms.",
    },
  ];
  ...
  const handleNext = () => { setIsAutoPlaying(false); setIsTransitioning(true); setCurrentIndex((prev) => prev + 1); };
  const handlePrev = () => { setIsAutoPlaying(false); setIsTransitioning(true); setCurrentIndex((prev) => prev - 1); };
        ...
        <section className="w-full bg-[#F6FDFF] py-16 lg:pt-32 lg:pb-16 overflow-hidden flex justify-center">
          <div className="w-full max-w-[1248px] px-6 lg:px-0 flex flex-col items-center">
            ...
            <motion.h2
              ...
              style={{ fontFamily: "'Onest', sans-serif" }}
            >
              {"Identifying business risks smarter, understanding customers better, and making faster decisions. Let's analyze your products together."
                .split("")
                .map((char, index) => (
                  <motion.span
                    key={index}
                    variants={{
                      hidden: { color: "#E4E4E4" },
                      visible: { color: "#042718", transition: { duration: 0.5, ease: "easeOut" } },
                    }}
                  >
                    {char}
                  </motion.span>
          ...
          <div className="w-full max-w-[1440px] flex flex-col items-center overflow-hidden">
            ...
            <div className="w-full max-w-[1248px] px-6 lg:px-0 flex flex-col items-center text-center mt-0 mb-16">
              ...
              <h2
                ...
                style={{ fontFamily: "'Onest', sans-serif" }}
              >
                Trusted by business owners <i className="text-[rgba(0,0,0,0.40)]">who take</i> control of their growth
              </h2>

              <p className="text-[#042718] opacity-80 text-[16px] md:text-[18px] leading-[24px] md:leading-[28px] max-w-[576px]">
                See how sellers and entrepreneurs are identifying risks, understanding customers, and making smarter decisions with RiskAI.
              </p>
            </div>
                      ...
                      >
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full h-full justify-center">
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <p className={"font-medium text-[16px] md:text-[18px] leading-[28px] text-center mb-[4px] transition-colors duration-500 " + (isActive ? "text-white" : "text-[#042718]")}>
                              {item.name}
                            </p>
                            <p className={"text-[12px] md:text-[14px] leading-[20px] text-center transition-colors duration-500 " + (isActive ? "text-white/80" : "text-[#042718] opacity-80")}>
                              {item.role}
                            </p>
                          </div>
                        </div>
