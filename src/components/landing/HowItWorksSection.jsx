...
const steps = [
  {
    ...
    icon: Link,
    heading: "Paste a Product URL",
    subheading: "Simply paste any supported e-commerce product URL — such as Daraz or Amazon — and our system instantly validates it and prepares for analysis.",
    list: [
  ...
  {
    id: 2,
    label: "AI Fetches Reviews",
    icon: Search,
    heading: "AI Fetches Customer Reviews",
    subheading: "Our backend automatically scrapes and processes hundreds of real customer reviews from the product page, filtering out spam and duplicates.",
    list: [
      "Scrapes up to 1000+ real reviews",
  ...
  {
    id: 3,
    label: "AI Performs Analysis",
    icon: Brain,
    heading: "Deep Business Risk Analysis",
    subheading: "Advanced AI models analyze every review for sentiment, risk patterns, complaint frequency, strengths, weaknesses, and Business Risk Index (BRI) calculation.",
    list: [
  ...
  {
    id: 4,
    label: "View Insights & Actions",
    icon: BarChart3,
    heading: "View Insights & Recommendations",
    subheading: "Explore your results through an interactive dashboard with charts, risk scores, evidence cards, and prioritized AI-generated recommendations.",
    list: [
...
export default function HowItWorksSection({ className }) {
  ...
  return (
    <>
      ...
      <section id="how-it-works" className={"w-full bg-[#F6FDFF] py-20 lg:py-32 overflow-hidden " + (className || "")}>
                ...
                <div className="w-full bg-white rounded-[32px] border border-[#042718]/[0.04] shadow-[0_0_20px_0_rgba(4,39,24,0.04)] flex flex-col lg:flex-row items-center justify-between p-6 lg:pt-4 lg:pr-4 lg:pb-4 lg:pl-16 gap-12 lg:gap-0 overflow-hidden">
                  ...
                  <div className="w-full lg:w-[534px] flex flex-col items-start text-left">
                    ...
                    >
                      ...
                      <motion.div layout className="w-10 h-10 rounded-full bg-white flex items-center justify-center relative overflow-hidden">
                        <motion.div
                          animate={{
